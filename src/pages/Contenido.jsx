...
function SelectorPuestos({ seleccionados, onChange, disabled }) {
  return (
    <select
      ...
      className="w-full border border-[#EFDDCE] rounded-lg text-sm outline-none px-1 py-1 disabled:opacity-60 [&>option:checked]:text-[#2C2C2A] [&>option:checked]:[background:linear-gradient(#FBEAE3,#FBEAE3)]"
    >
